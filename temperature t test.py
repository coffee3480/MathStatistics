...
#Задача: найти данные по среднегодовой температуре. При помощи теста Стьюдента выяснить: действительно ли возросла температура?
...
data1av=MathStat.arithmetic_average(data1)
data2av=MathStat.arithmetic_average(data2)
